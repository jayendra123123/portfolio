  ...
  <section id="projects" className="max-w-4xl mx-auto py-16 px-4">
    ...
    <h2 className="projects-section-title text-3xl md:text-4xl font-bold mb-8 text-center animate-fade-in-up">My Creations</h2>
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <CardContainer className="mb-2" containerClassName="">
          <CardBody className="project-card w-full min-h-[22rem] bg-white/80 dark:bg-neutral-900/80 rounded-2xl p-6 flex flex-col justify-between border border-white/30 dark:border-neutral-800/60">
            <CardItem translateZ={40} rotateY={10} className="flex items-center justify-center mb-3">
            ...
            <CardItem translateZ={60} rotateX={5} className="text-xl font-semibold mb-2 text-indigo-700 dark:text-indigo-400">LambdaAttend: Student Attendance Tracker</CardItem>
            <CardItem translateZ={30} rotateY={-5} className="flex flex-wrap gap-2 mb-2">
              <span className="project-tag">AWS Lambda</span>
              <span className="project-tag">Python</span>
              <span className="project-tag">WebSocket</span>
            </CardItem>
            <CardItem translateZ={20} className="text-gray-700 dark:text-gray-300 mb-2 text-sm">
        ...
        <CardContainer className="mb-2" containerClassName="">
          <CardBody className="project-card bg-white/80 dark:bg-neutral-900/80 rounded-2xl p-6 flex flex-col border border-white/30 dark:border-neutral-800/60">
            <CardItem translateZ={40} rotateY={10} className="flex items-center justify-center mb-3">
            ...
            <CardItem translateZ={60} rotateX={5} className="text-xl font-semibold mb-2 text-indigo-700 dark:text-indigo-400">CineScope: Movie Review Platform</CardItem>
            <CardItem translateZ={30} rotateY={-5} className="flex flex-wrap gap-2 mb-2">
